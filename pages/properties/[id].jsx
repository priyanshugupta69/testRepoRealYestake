...
export const getStaticProps = async (context) => {
  ...
  const result = await axios.get(`http://localhost:3000/api/properties/view/${id}`);
  return {
    props: {
  ...
  return (
    <div className="container mx-auto px-4">
      ...
      <div className="mt-5 flex flex-row gap-4">
        ...
        <Button className="bg-[#D8242F] capitalize rounded-[47px] text-white py-[12px] px-16  Outfit text-[16px] leading-[20.16px] font-normal">Delete Property</Button>
      </div>
