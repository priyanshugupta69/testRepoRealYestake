...
import Link from "next/link";
  ...
  export function FavCard({_id,  title, place, content, price, isNew, isLiked, picture}) {
    ...
    >
      ...
      >
        ...
        <Link href={`/properties/${_id}`}>
          ...
          <Button className="rounded-[47px] hover:bg-[#F64070] hover:text-white bg-white text-[#F64070] text-[12px] font-normal leading-[17.64px] border border-[#FDACD3] px-10 py-[10px]">Enquire Now</Button>
        </CardFooter>
      </Card>
    );
  }
